package crowd_framework.core 
{
	...
	public class SocialTypes 
	{
		...
		public static function getSocialTypeByFlashVars(flashvars:IVarsHolder):String {
			if (flashvars.hasValue("api_id") && flashvars.hasValue("viewer_id")) return null;
			if (flashvars.hasValue("oid") && flashvars.hasValue("vid")) return null;
			if (flashvars.hasValue("logged_user_id") && flashvars.hasValue("apiconnection")) return null;
